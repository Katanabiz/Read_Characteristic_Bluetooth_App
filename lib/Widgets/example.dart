...
//   attributes
//       .addAll({"00002a03-0000-1000-8000-00805f9b34fb": "Reconnection Address"});
//   attributes.addAll({
...
//   attributes.addAll({"00002a07-0000-1000-8000-00805f9b34fb": "Tx Power Level"});
...
//   attributes.addAll({"00002a0a-0000-1000-8000-00805f9b34fb": "Day Date Time"});
//   attributes.addAll({"00002a0b-0000-1000-8000-00805f9b34fb": "Exact Time 100"});
//   attributes.addAll({"00002a0c-0000-1000-8000-00805f9b34fb": "Exact Time 256"});
...
//   attributes
//       .addAll({"00002a10-0000-1000-8000-00805f9b34fb": "Secondary Time Zone"});
//   attributes.addAll({"00002a11-0000-1000-8000-00805f9b34fb": "Time with DST"});
//   attributes.addAll({"00002a12-0000-1000-8000-00805f9b34fb": "Time Accuracy"});
...
//   attributes.addAll({"00002a15-0000-1000-8000-00805f9b34fb": "Time Broadcast"});
//   attributes.addAll(
...
//   attributes
//       .addAll({"00002a18-0000-1000-8000-00805f9b34fb": "Glucose Measurement"});
//   attributes.addAll({"00002a19-0000-1000-8000-00805f9b34fb": "Battery Level"});
//   attributes
//       .addAll({"00002a1a-0000-1000-8000-00805f9b34fb": "Battery Power State"});
//   attributes
//       .addAll({"00002a1b-0000-1000-8000-00805f9b34fb": "Battery Level State"});
//   attributes.addAll(
...
//   attributes
//       .addAll({"00002a1f-0000-1000-8000-00805f9b34fb": "Temperature Celsius"});
//   attributes.addAll(
//       {"00002a20-0000-1000-8000-00805f9b34fb": "Temperature Fahrenheit"});
//   attributes
//       .addAll({"00002a21-0000-1000-8000-00805f9b34fb": "Measurement Interval"});
//   attributes.addAll(
...
//   attributes
//       .addAll({"00002a24-0000-1000-8000-00805f9b34fb": "Model Number String"});
//   attributes
//       .addAll({"00002a25-0000-1000-8000-00805f9b34fb": "Serial Number String"});
//   attributes.addAll(
...
//   attributes
//       .addAll({"00002a2c-0000-1000-8000-00805f9b34fb": "Magnetic Declination"});
...
//   attributes
//       .addAll({"00002a38-0000-1000-8000-00805f9b34fb": "Body Sensor Location"});
//   attributes.addAll(
...
//   attributes
//       .addAll({"00002a3e-0000-1000-8000-00805f9b34fb": "Network Availability"});
//   attributes.addAll({"00002a3f-0000-1000-8000-00805f9b34fb": "Alert Status"});
//   attributes
//       .addAll({"00002a40-0000-1000-8000-00805f9b34fb": "Ringer Control point"});
//   attributes.addAll({"00002a41-0000-1000-8000-00805f9b34fb": "Ringer Setting"});
//   attributes.addAll(
...
//   });
//   attributes
//       .addAll({"00002a45-0000-1000-8000-00805f9b34fb": "Unread Alert Status"});
...
//   attributes.addAll({"00002a4e-0000-1000-8000-00805f9b34fb": "Protocol Mode"});
//   attributes
//       .addAll({"00002a4f-0000-1000-8000-00805f9b34fb": "Scan Interval Window"});
...
//   attributes.addAll({"00002a57-0000-1000-8000-00805f9b34fb": "Digital Output"});
//   attributes.addAll({"00002a58-0000-1000-8000-00805f9b34fb": "Analog"});
//   attributes.addAll({"00002a59-0000-1000-8000-00805f9b34fb": "Analog Output"});
...
//   attributes
//       .addAll({"00002a64-0000-1000-8000-00805f9b34fb": "Cycling Power Vector"});
//   attributes.addAll(
...
//   attributes
//       .addAll({"00002a71-0000-1000-8000-00805f9b34fb": "True Wind Direction"});
//   attributes
//       .addAll({"00002a72-0000-1000-8000-00805f9b34fb": "Apparent Wind Speed"});
//   attributes.addAll(
...
//   attributes
//       .addAll({"00002a75-0000-1000-8000-00805f9b34fb": "Pollen Concentration"});
...
//   });
//   attributes
//       .addAll({"00002a83-0000-1000-8000-00805f9b34fb": "Anaerobic Threshold"});
//   attributes.addAll({
//     "00002a84-0000-1000-8000-00805f9b34fb": "Aerobic Heart Rate Upper Limit"
//   });
//   attributes.addAll({"00002a85-0000-1000-8000-00805f9b34fb": "Date of Birth"});
//   attributes.addAll(
//       {"00002a86-0000-1000-8000-00805f9b34fb": "Date of Threshold Assessment"});
//   attributes.addAll({"00002a87-0000-1000-8000-00805f9b34fb": "Email Address"});
//   attributes.addAll({
...
//   attributes.addAll({"00002a8d-0000-1000-8000-00805f9b34fb": "Heart Rate Max"});
...
//   attributes
//       .addAll({"00002a97-0000-1000-8000-00805f9b34fb": "Waist Circumference"});
...
//   attributes
//       .addAll({"00002a9e-0000-1000-8000-00805f9b34fb": "Weight Scale Feature"});
//   attributes
...
//   attributes
//       .addAll({"00002aab-0000-1000-8000-00805f9b34fb": "CGM Session Run Time"});
//   attributes.addAll({
...
//   attributes.addAll({"00002ab5-0000-1000-8000-00805f9b34fb": "Location Name"});
...
//   attributes.addAll({"00002abb-0000-1000-8000-00805f9b34fb": "HTTPS Security"});
//   attributes
...
//   attributes
//       .addAll({"00002ac1-0000-1000-8000-00805f9b34fb": "Object First-Created"});
//   attributes
//       .addAll({"00002ac2-0000-1000-8000-00805f9b34fb": "Object Last-Modified"});
...
//   attributes.addAll({"00002ac8-0000-1000-8000-00805f9b34fb": "Object Changed"});
//   attributes.addAll({
...
//   attributes.addAll({"00002acd-0000-1000-8000-00805f9b34fb": "Treadmill Data"});
//   attributes
...
//   attributes.addAll({"00001800-0000-1000-8000-00805f9b34fb": "Generic Access"});
//   attributes
...
//   attributes
//       .addAll({"00001805-0000-1000-8000-00805f9b34fb": "Current Time Service"});
//   attributes.addAll({
...
//   attributes
//       .addAll({"0000180f-0000-1000-8000-00805f9b34fb": "Battery Service"});
//   attributes.addAll({"00001810-0000-1000-8000-00805f9b34fb": "Blood Pressure"});
//   attributes.addAll(
...
//   attributes.addAll({"00001815-0000-1000-8000-00805f9b34fb": "Automation IO"});
//   attributes.addAll(
//       {"00001816-0000-1000-8000-00805f9b34fb": "Cycling Speed and Cadence"});
//   attributes.addAll({"00001818-0000-1000-8000-00805f9b34fb": "Cycling Power"});
//   attributes.addAll(
...
//   attributes
//       .addAll({"00001824-0000-1000-8000-00805f9b34fb": "Transport Discovery"});
//   attributes.addAll(
...
// String lookup1(String uuid) {
//   return lookup2(uuid, "--");
// }

// String lookup2(String uuid, String defaultName) {
//   var attributes = getAllGattCharacters();
//   var nameExist = attributes.containsKey(uuid);
//   return (!nameExist) ? defaultName : attributes[uuid];
// }

// // getJavaStaticList(data) {
// //   //attributes.put("0000${d.code.substr(2).toLowerCase()}-0000-1000-8000-00805f9b34fb", "${d.name}");\n`;
// // }

// parseManufacturerData(data) {
//   if (data.toString() == "{}") return;

//   var manufacturerData = Uint8List.fromList(data[6]);
...
//   debugPrint("Pressure: ${pressure.getUint32(0, Endian.little) / 100} psi");
//   debugPrint(
//       "Temperature: ${temperature.getUint32(0, Endian.little) / 100} \u{00B0}C");
//   debugPrint("Battery: ${battery.getUint8(0)} %");
// }

// readCharacteristics(device) async {
...
//                       await c.read().then((v) => {
//                             print(
//                                 "value: ${ByteData.sublistView(Uint8List.fromList(v), 0, 1).getUint8(0)}")
//                           });

//                       //parseManufacturerData(c.value);
//                       var value =
//                           lookup1(c.serviceUuid.toString().toLowerCase());
//                       print(value);
//                       //readCharacteristics(s.characteristics);
//                     },
